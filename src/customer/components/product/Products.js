...
import { filters, singleFilter } from "../../utilities/FilterData";
import {
  FormControl,
  FormControlLabel,
  FormLabel,
        ...
        <main className="mx-auto px-4 sm:px-6 lg:px-20">
            ...
            <div className="grid grid-cols-1 gap-x-8 gap-y-10 lg:grid-cols-5">
              <div>
                <div className="flex flex-row justify-between items-center py-5">
                  <h1 className="text-xl opacity-55">Filters</h1>
                  <TuneIcon />
                </div>
          ...
          <section className="w-full m-3">
            <div className="p-2 flex justify-center">
              <Pagination count={products?.products?.totalPages} color="primary" onChange={handlePagination}/>
            </div>
          </section>
        </main>
      </div>
